...
server_id="$(docker run -it -d --network z32_network --hostname z32_server_py --network-alias z32_server_py --name z32_server_py z32_server_py --IP z32_server_py)"
...
server_id="$(docker run -it -d --network z32_network --hostname z32_server_py --network-alias z32_server_py --ip '172.21.32.2' --name z32_server_py z32_server_py --IP z32_server_py --PORT 8080)"
client_id="$(docker run -it -d --network-alias z32_client --ip '172.21.32.3' --network z32_network --name z32_client z32_client)"
